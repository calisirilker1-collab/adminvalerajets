(() => {
  ...
  function currentRfqFormData(){const f=$('rfqForm'),fd=new FormData(f);return {operator_name:String(fd.get('operator_name')||'').trim(),operator_email:String(fd.get('operator_email')||'').trim(),subject:String(fd.get('subject')||'').trim(),body:String(fd.get('body')||'').trim()};}
